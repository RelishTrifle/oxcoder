        ...
        private void SetDataBind()
        {
            ...
            for (int i = 0; i < result.Length; i++)
            {
                ...
                s += "<div class='col-md-12'><div class='panel panel-default project '><div class='panel-body'>" +
                    "<div class='row'><!-- new start--><div class='col-md-5'><h2 style='margin: 12px 0 2px 0;'>	<a href='#' class='challenge_name'>" + result[i, 0] + "</a> <!--去筛选-->" +
                    ...
                    "</small></div></div><div class='col-md-3'><a href='/company/invite.aspx' class='btn btn-new1' style='margin: 16px 5px;'>邀请</a></div></div></div></div></div>";		
            }
